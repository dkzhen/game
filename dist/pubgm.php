...
if (isset($_POST['submit'])) {
    ...
    if (orderPubgMobile($_POST) > 0 ) {
        echo "<script>alert('Data berhasil dimasukkan');
        document.location.href='pesanan_pubg.php'</script>";
    } else {
        echo "<script>alert('Data Gagal dimasukkan');
        document.location.href='pubgm.php'</script>";
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="content">
            <form action="" method="post">
                            ...
                            <fieldset>
                                ...
                                <label for="13" class="lbl-radio">
                                    <div class="display-box">
                                        ...
                                        <div class="dm">Bundel Gacha
                                            <input type="hidden" name="contoh" id="130" value="Contoh">
                                        </div>
                                ...
                                <label for="14" class="lbl-radio">
                                    <div class="display-box">
                                        <div class="img"><img src="libs/img/royalepass.jpg" style="border-radius: 10px;">
                                        </div>
                ...
                <div class="email">
                    ...
                    <div class="button">
                        <button type="submit" name="submit" class="btn">Beli Sekarang</button>
                    </div>
                </div>
            </form>
        </div>
